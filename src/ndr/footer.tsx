    ...
    <footer className="bg-[#f8f9fa] p-5">
      <div className="container p-4 mx-auto">
        <div className="content flex flex-col items-center justify-center lg:mb-4 gap-4">
          ...
          <div className="footer-links w-full flex items-center justify-center bg-[#FDDEE580] max-w-lg xl:max-w-2xl ">
            <div className="copyright w-full p-2 xl:p-4 flex flex-col items-center justify-center gap-2.5">
              <p className="text-xs text-center xl:text-sm text-[#999999] md:max-w-[420px] max-w-[184px] lg:max-w-[550px] 2xl:max-w-4xl">&copy; {currentYear} Nation One Debt Relief | All rights reserved | <Link href="/privacy-policy" className="text-xs xl:text-sm text-center text-[#999999] max-w-[184px] no-underline hover:text-[#666666] transition-colors">Privacy Policy</Link> | <Link href="/terms-of-use" className="text-xs xl:text-sm text-center text-[#999999] max-w-[184px] no-underline hover:text-[#666666] transition-colors">Terms and Conditions</Link></p>
            </div>
          </div>
        </div>
      </div>
