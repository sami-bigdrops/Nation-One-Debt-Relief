...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <div className="p-4 md:p-6 lg:p-10 xl:p-18 xl:px-40 xl:py-30 bg-white">
        <div className="content flex flex-col gap-6 md:gap-8 lg:gap-10">
          <div className="legal-content bg-white rounded-[10px] shadow-[0_8px_16px_rgba(0,0,0,0.1)] p-4 md:p-6 lg:p-8 xl:p-10">
            <div className="legal-title">
              <h1 className="text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl mb-6 md:mb-8 lg:mb-10 text-gray-900 text-center">
                Privacy Policy
              </h1>
            </div>
            ...
            <div className="legal-description">
              <section className="mb-6 md:mb-8 lg:mb-10">
                <h2 className="text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-medium text-[#003995] mb-3 md:mb-4 lg:mb-5">
                  Introduction
                </h2>
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  <a
                    href="https://www.nationonedebtrelief.com"
                    className="text-[#003995] no-underline transition-colors duration-300 ease-in-out font-medium hover:text-[#F31B47] hover:underline"
                  >
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  (our &quot;Website&quot;) and our practices for collecting,
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    On this Website.
                  </li>
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  ...
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    advertising) that may link to or be accessible from or on
                    the Website.
                  </li>
                </ul>
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  age. No one under age 16 may provide any information to or on
                  the Website. We do not knowingly collect personal information
                  from children under 16. If you are under 16, do not use or
                  provide any information on this Website or on or through any
                  of its features. If we learn we have collected or received
                  ...
                  <a
                    href="mailto:contact@nationonedebtrelief.com"
                    className="text-[#003995] no-underline transition-colors duration-300 ease-in-out font-medium hover:text-[#F31B47] hover:underline"
                  >
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  information. Please see Your California Privacy Rights for
                  more information.
                </p>
              </section>
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    postal address, e-mail address, telephone number, social
                    security number, or any other identifier by which you may be
                    contacted online or offline (&quot;personal
                    information&quot;);
                  </li>
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  (hereinafter, &quot;posted&quot;) on public areas of the
                  Website, or transmitted to other users of the Website or third
                  parties (collectively, &quot;User Contributions&quot;). Your
                  User Contributions are posted on and transmitted to others at
                  your own risk. Although we limit access to certain pages,
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  information, or we may maintain it or associate it with
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  ...
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    and on our Website. Flash cookies are not managed by the
                    same browser settings as are used for browser cookies. For
                    information about managing your privacy and security
                    settings for Flash cookies, see Choices About How We Use and
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  you should contact the responsible provider directly. For
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  ...
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    To provide you with notices about your account and, if
                    applicable, changes to any products or services we offer or
                    provide through it.
                  </li>
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  on which we collect your data (the registration form). For
                  more information, see Choices About How We Use and Disclose
                  Your Information.
                </p>
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    request. o To enforce or apply our terms of use and other
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  We work with trusted partners to better serve our customers.
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  Information shared with our partners is subject to their
                  respective privacy policies and practices. We encourage you to
                  review their privacy policies for more information about how
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    page on Adobe&apos;s website. If you disable or refuse
                    cookies, please note that some parts of this site may then
                  ...
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    purposes, you can opt out by checking the relevant box
                    located on the form on which we collect your data (the
                    registration form). You can also always opt out by checking
                    or unchecking the relevant boxes or by sending us an email
                    stating your request to contact@nationonedebtrelief.com.
                  </li>
                </ul>

                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  promotional purposes, you can opt out by checking the relevant
                  box located on the form on which we collect your data (the
                  registration form). You can also always opt out by checking or
                ...
                <ul className="list-disc pl-6 md:pl-8 lg:pl-[30px] xl:pl-[35px] my-4 md:my-5 lg:my-6">
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    have your contact information used by the Company to promote
                    our own or third parties&apos; products or services, you can
                    opt out by checking the relevant box located on the form on
                    which we collect your data (the registration form) or at any
                    other time by sending us an email stating your request to
                    www.nationonedebtrelief.com. If we have sent you a
                    promotional email, you may send us a return email asking to
                    be omitted from future email distributions.
                  </li>
                  <li className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-3 md:mb-4 lg:mb-5 pl-2 md:pl-3 lg:pl-[5px]">
                    ...
                    target-audience preferences, you can opt out by checking the
                    relevant box located on the form on which we collect your
                    data (the registration form) or at any other time by sending
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  Advertising Initiative (&quot;NAI&quot;) on the NAI&apos;s
                  website.
                </p>
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  rights under Nevada Revised Statutes Chapter 603A may submit a
                  request to this designated address:
                  contact@nationonedebtrelief.com.
                </p>
              </section>
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  If you are a California resident, California law may provide
                  you with additional rights regarding our use of your personal
                  information. To learn more about your California privacy
                  rights, visit the CCPA privacy notice for California
                  Residents.
                </p>
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  or write us at: 12540 SW Leveton Dr, #P2150 Tualatin, OR,
                  97062.
                </p>
              </section>
              ...
              <section className="mb-6 md:mb-8 lg:mb-10">
                ...
                <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-[1.6] md:leading-[1.7] lg:leading-[1.8] text-[#1E1E1E] mb-4 md:mb-5 lg:mb-6">
                  ...
                  to us is stored on our secure servers behind firewalls. Any
